/// All things related to the conference data
library conference_data;

export 'src/conference_data.dart';
export 'src/domain/conference_data_source.dart';
...
export 'src/domain/use_case/get_conference_data_use_case.dart';
